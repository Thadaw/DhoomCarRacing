...
public class editorScript : EditorWindow{
    ...
    void buttos(){
        ...
        if(GUILayout.Button("Add Components" , GUILayout.Height(40))){
            //AddComponents();
        }
        //wheel prefabs
        if(collidersContainer != null)
    ...
    void wheelsProperties(){
        ...
        frontOffset.x = EditorGUILayout.Slider(frontOffset.x,0.5f, 1.25f);
        EditorGUILayout.EndHorizontal();
        ...
        rearOffset.x = EditorGUILayout.Slider(rearOffset.x,0.5f, 1.25f);
        EditorGUILayout.EndHorizontal();
