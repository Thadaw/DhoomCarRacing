...
namespace World.Culling {
    public class WorldChunksStreamer : MonoBehaviour {
        ...
        public string dataFileMostWanted = "";
        public string modelsFileMostWanted = "";
        ...
        public void Initialize() {
            ...
            if (string.IsNullOrEmpty(dataFileToUse) || string.IsNullOrEmpty(modelsFileToUse)) {
                Debug.LogError("WorldChunksStreamer: data file paths are not set. Assign them in the Inspector.");
                return;
            }

            if (!File.Exists(modelsFileToUse)) {
                Debug.LogError("WorldChunksStreamer: models file not found: " + modelsFileToUse);
                return;
            }

            if (!File.Exists(dataFileToUse)) {
                Debug.LogError("WorldChunksStreamer: data file not found: " + dataFileToUse);
                return;
            }
